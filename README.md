...
## Table of Contents
- [💻 GVSU x GRPS Hackathon Technical Information](#-gvsu-x-grps-hackathon-technical-information)
...
- [⚠️ Safety:](#️-safety)
  ...
  - [Commands to Know:](#commands-to-know)
    ...
    - [Move up one folder:](#move-up-one-folder)
    - [Move Back to root (In this case "/home/techshow1”):](#move-back-to-root-in-this-case-hometechshow1)
    - [List all files in Folder:](#list-all-files-in-folder)
    - [Show Python Library Version:](#show-python-library-version)
...
- [Create Virtual Environment:](#create-virtual-environment)
  ...
  - [Where to create python files in a venv:](#where-to-create-python-files-in-a-venv)
...
- [Misc. Diagrams](#misc-diagrams)
  ...
  - [Button Diagram:](#button-diagram)
    - [Pull-up/Pull-down resistor:](#pull-uppull-down-resistor)
  - [LEDs:](#leds)
...
- [HATs in IoT Systems](#hats-in-iot-systems)
  ...
  - [GPIO - Buttons, LEDs, Servo, Buzzers:](#gpio---buttons-leds-servo-buzzers)
    - [GPIO Switch Example Code:](#gpio-switch-example-code)
- [Neopixels:](#neopixels)
...
- [📡 RFID – Using the RC522 Reader on Raspberry Pi 5](#-rfid--using-the-rc522-reader-on-raspberry-pi-5)
  ...
  - [Installing the RFID Library (Required)](#installing-the-rfid-library-required)
    - [2. Install Pi 5–compatible library](#2-install-pi-5compatible-library)
    - [🔧 Required installation commands:](#-required-installation-commands)
